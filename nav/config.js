...
window.NAV_CONFIG_DEFAULT = {
  ...
  settings: {
    ...
    showPayday: true,
    payDay: 10,
    weekendMode: "alwaysDual",
    weekendWeekLog: {},
    showStickyNotes: true
  },
  // 左侧边栏导航项：整体或单独启用/禁用，可拖拽排序；不可编辑/删除
  sideItems: [
